...
# other end to make ICOLEN. Do it again to get COLENI, and so on. For the
# purpose of today's challenge, we'll say that the strings "nicole", "icolen",
...
def same_necklace(Name1, Name2):
    ...
    for x in range(len(Name1List)):
        if Name1List == Name2List:
            return True
        else:
            POPED = Name1List.pop()
            Name1List.insert(0, POPED)
    return False
